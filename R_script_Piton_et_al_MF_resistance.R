...
D=read.csv("https://raw.githubusercontent.com/GabinPiton/Drought-resistance-of-soil-multifunctionality/refs/heads/main/Data_Piton_et_al_MF_resistance.csv",sep=";")
